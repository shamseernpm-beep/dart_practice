void main() {
  ...
  print(std.startsWith("r"));
  print(std.endsWith("n"));
  ...
  var unionSet = one.union(two);
  print(unionSet);

  var differenceSet = one.difference(two);
  print(differenceSet);

  var differenceSet2 = two.difference(one);
  print(differenceSet2);

  var intersectionSet = one.intersection(two);
